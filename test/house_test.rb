...
class HouseTest < Minitest::Test
  ...
  def test_it_can_sort_rooms_by_area
    ...
    house.add_room(room_4) #area = 1230
    house.add_room(room_1) #area = 130
    house.add_room(room_3) #area = 375
    house.add_room(room_2) #area = 165
  ...
  def test_it_can_sort_rooms_by_category
    ...
    assert_equal sorted_rooms, house.rooms_by_category
  end
end
